...
ui: {
  ...
  'u-kyr':'tis. r/s','u-myr':'mil. r/s','e-kyr':'tis. r','e-myr':'mil. r','e-gyr':'mld. r',
  ...
  'life-unicellular':'jednobunkový','life-sterile':'sterilný',
  'st-bio-now':'Biosféra (aktuálna)',
  'bio-extinct-val':'mnohobunkový život vyhynul — ostali len mikróby',
  'bio-sterile-val':'VŠETOK život vyhynul — svet je sterilný',
  'life-complex':'mnohobunkový',
  'bio-extinct-now':'zložitý život vyhynul, keď {why} ({when}) — ostali len mikróby',
  'bio-sterile-now':'VŠETOK život vyhynul, keď {why} ({when}) — sterilný',
  'bio-reevolved-now':'zložitý život sa znovu vyvinul ({when}) — zatiaľ bez inteligencie',
  'life-ago':'odvtedy: {ago}','life-now':'práve teraz',
  'ext-note-clim':'Zložitý život vyhynul, keď {why}. Mikróby prežili v hlbokej kôre a všade, kde sa dalo, a šíria sa späť, ako im to podnebie dovolí; zložitému životu trvá stovky miliónov rokov, kým sa znovu vyvinie, a inteligencii ďalšiu pol miliardu. (🧽 Uzdraviť v impaktnom laboratóriu biosféru obnoví.)',
  'ext-note-sterile-clim':'Neprežilo nič, keď {why}. Keďže sa nemá čo šíriť späť, svet zostane sterilný. (🧽 Uzdraviť v impaktnom laboratóriu biosféru obnoví.)',
  'ext-note-reevolved':'Od vyhynutia sa zložitý život znovu vyvinul. Inteligencia potrebuje pol miliardy rokov zložitého života. (🧽 Uzdraviť v impaktnom laboratóriu obnoví biosféru takú, aká bola.)',
  'lc-heat':'sa povrch príliš prehrial','lc-boiled':'sa oceány vyvarili','lc-cooked':'teplo preniklo hlboko do kôry',
  'lc-magma':'sa kôra roztavila','lc-frozen':'svet zamrzol','lc-dry':'sa voda stratila',
  'lc-anoxia':'došiel kyslík','lc-starved':'CO₂ kleslo príliš nízko na fotosyntézu','lc-unknown':'sa zmenilo podnebie',
  'ext-note':'Bombardovanie sterilizovalo povrch: všetky zvieratá, rastliny aj huby zmizli. Jednobunkový život prežíva už len hlboko v horninách a vo zvyškoch morí. (🧽 Uzdraviť v impaktnom laboratóriu biosféru obnoví.)',
  'ext-note-sterile':'Bombardovanie prekročilo exaton TNT: neprežilo nič, ani mikróby. Svet je úplne sterilný. (🧽 Uzdraviť v impaktnom laboratóriu biosféru obnoví.)',
  ...
  'orb-edit':'Dráha (a · e)','orb-apply':'Nastav',
  ...
  'st-water-now':'Doručená voda',
  'tier-massloss':' · hmotnosť −{p} %',
  'st-ring':'Prstenec trosiek','st-ring-v':'☄ rozmazáva sa pozdĺž pôvodnej dráhy',
  'st-blast':'Následok výbuchu','st-blast-v':'radiačná vlna a orbitálne vyhodenie',
  ...
  'dmg-scarred':'zjazvený','dmg-heavy':'ťažko poškodený','dmg-boiled':'oceány vyvreté',
  'dmg-molten':'roztavený povrch','dmg-critical':'na hranici rozpadu',
...
html: {
  ...
  't-temp':'🌡 Teplota','t-cloud':'☁ Oblaky',
  'help-clim-h':'Klíma',
  'help-clim':'Každý kamenný, ľadový aj oceánsky svet má živý <b>klimatický model</b> (Planet Climate Sandbox: energetická bilancia v 18 pásoch s oceánmi, ľadom, oblakmi, uhlíkovým cyklom a únikom do vesmíru), ohrievaný svetlom, ktoré naozaj dostáva na svojej aktuálnej dráhe. <b>Presuňte svet</b> (✎ dráha, 🌌 N-telesá, zrážky), <b>zjasnite či stlmte hviezdu</b>, <b>zasiahnite ho</b> (💥) alebo <b>zmeňte jeho vzduch a vodu</b> v informačnom paneli — a sledujte, ako reagujú ľadové čiapočky, moria, lesy a para. Pre geologické zmeny nastavte <b>Rýchlosť</b> na tisíce až milióny rokov za sekundu (N-telesá čas obmedzujú, vtedy ich vypnite). <b>🌡 Teplota</b> zafarbí každý svet podľa teploty povrchu.',
...
titles: {
  ...
  't-temp':'Teplotný pohľad — zafarbí každý svet podľa teploty jeho povrchu',
  't-cloud':'Oblaky — oblačná pokrývka, para a opar z klímy; vypnuté ukážu povrch (oblaky namaľované priamo do mapy sveta zostanú)',
  ...
  'imp-surface':'Podrží vybraný svet pod kamerou: pohľad ho sleduje a jeho rotácia stojí, kým čas beží ďalej',
  't-surface':'Podrží vybraný svet pod kamerou: pohľad ho sleduje a jeho rotácia stojí, kým čas beží ďalej',
